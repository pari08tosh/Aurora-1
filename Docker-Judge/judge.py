...
sql_hostname = '172.16.86.222'
sql_hostport = 3306
sql_username = 'username'
sql_password = 'yoursqlpassword'
sql_database = 'dbname'
HOST, PORT = "0.0.0.0", 8720
#timeoffset = 19800
...
"C++": {"extension": "cpp", "system": "find /usr/bin/ -name g++", "compile": "g++ -std=c++14 env/[codefilename].cpp -O2 -fomit-frame-pointer -o env/[codefilename]"+ioeredirect, "execute": "env/[exename][inputfile]"},
...
"JavaScript": {"extension":"js", "system": "find /usr/bin/ -name node", "execute":"node env/[exename].js[inputfile]"},
