...
if (True) {
    if (True) {
    // Block registration with alert.
	$_SESSION['msg'] = "Registration Closed";
        redirectTo(SITE_URL);
    }
    ?>
    <script type='text/javascript'>
        ...
        function validate(){
                var regex = /[A-Z]{2,6}[/][0-9]{4,5}[/]201[2-9]$/;
                //var regex = /[A-Z]{2,6}[/][0-9]{4,5}[/]201[2-5]$/;
    ...
    <form method='post' class='form-horizontal'  role="form" onsubmit="return validate()" action='<?php echo SITE_URL; ?>/process.php'>
        <div class='col-lg-12'>
            ...
            <div class='form-group'>
                ...
                <div class='col-lg-4'><input class='form-control' type='text' name='roll1' id='roll1' required data-placement='right' title='Ex : BE/10206/2013 or BTECH/10111/2018'<?php
